...
public class MailServiceImpl implements MailService {
    ...
    public void sendNotificaitionAsync(User user) throws MailException, MessagingException {
        ...
        String htmlContent = "<html>" +
                ...
                "<p style='margin-top: 40px; font-size: 12px; color: #999;'>This link will expire in 5 minutes.</p>" +
    ...
    @Async
    public void sendRecoverNotificationAsync(User user) throws MailException, MessagingException {
        MimeMessage message = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true); // true = HTML
        ...
        String htmlContent = "<html>" +
                ...
                "<p style='font-size: 16px;'>Please click the button below to recover your account:</p>" +

                "<div style='text-align: center; margin: 30px 0;'>" +
                "<a href='" + activationLink + "' style='background-color: #28a745; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-size: 16px;'>Recover Account</a>" +
                "</div>" +
